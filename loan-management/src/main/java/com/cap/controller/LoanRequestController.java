...
public class LoanRequestController {
   ...
   //to add new loan request 
    ...
    public ResponseEntity<LoanRequestDetailsDto> add(@RequestBody CreateLoanRequestDto requestDto) {
        ...
        loanRequest.setLoanRoi(requestDto.getLoanRoi());
        loanRequest.setLoanStatus(requestDto.getLoanStatus());
